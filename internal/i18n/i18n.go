...
var messages = map[string]map[string]string{
	...
	"editor.too_many_slots": {
		...
		"pt-BR": "Total excede 36 slots (obteve %s). Remova ou redimensione os blocos.",
		"pt-PT": "Total excede 36 slots (obteve %s). Remova ou redimensione os blocos.",
		"es":    "El total excede 36 ranuras (obtuvo %s). Elimine o redimensione bloques.",
		"fr":    "Le total dépasse 36 emplacements (%s). Supprimez ou redimensionnez des blocs.",
		"de":    "Gesamt übersteigt 36 Slots (%s). Blöcke entfernen oder Größe ändern.",
		"it":    "Il totale supera 36 slot (ottenuti %s). Rimuovi o ridimensiona i blocchi.",
	},
	"editor.block_dim": {
		"en":    "Block %d: rows and columns must be at least 1.",
		"pt-BR": "Bloco %d: linhas e colunas devem ser pelo menos 1.",
		"pt-PT": "Bloco %d: linhas e colunas devem ser pelo menos 1.",
		"es":    "Bloque %d: filas y columnas deben ser al menos 1.",
		"fr":    "Bloc %d : les lignes et colonnes doivent valoir au moins 1.",
		"de":    "Block %d: Zeilen und Spalten müssen mindestens 1 sein.",
		"it":    "Blocco %d: righe e colonne devono essere almeno 1.",
	},
	"editor.app_name": {
