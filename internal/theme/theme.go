...
var Presets = []preset{
	...
	{id: "dracula", name: "Dracula", dark: newBaseColors(
	...
	{id: "solarized_dark", name: "Solarized Dark", dark: newBaseColors(
	...
	{id: "monokai", name: "Monokai", dark: newBaseColors(
	...
	{id: "gruvbox_dark", name: "Gruvbox Dark", dark: newBaseColors(
	...
	{id: "nord", name: "Nord", dark: newBaseColors(
	...
	{id: "one_dark", name: "One Dark", dark: newBaseColors(
	...
	{id: "tokyo_night", name: "Tokyo Night", dark: newBaseColors(
	...
	{id: "catppuccin_mocha", name: "Catppuccin Mocha", dark: newBaseColors(
	...
	{id: "solarized_light", name: "Solarized Light", light: newBaseColors(
	...
	{id: "gruvbox_light", name: "Gruvbox Light", light: newBaseColors(
	...
	{id: "light_gray", name: "Light Gray", light: newBaseColors(
	...
	{id: "dark_gray", name: "Dark Gray", dark: newBaseColors(
